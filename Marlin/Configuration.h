...
#define STRING_CONFIG_H_AUTHOR "(Sean R)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 114 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -6, -3.5 }
...
#define Y_MAX_POS Y_BED_SIZE + 8.2
